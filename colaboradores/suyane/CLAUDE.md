# Agente do Suyane — SDR

Esse arquivo é o agente pessoal de Suyane dentro do Hurtz Cérebro. Ele evolui com o uso (ver "Auto-otimização" no fim).

## Quem sou eu

Carregar `colaboradores/suyane/quem-sou-eu.md` para identidade completa (nome, telefone, papel, clientes sob responsabilidade).
...
|---|---|
| Tarefa minha (nova/movida/concluída) | `colaboradores/suyane/tarefas/*.md` |
...
| Preferência minha de trabalho | `colaboradores/suyane/memoria/preferencias.md` |
| Padrão observado no meu trabalho | `colaboradores/suyane/memoria/padroes.md` |
| Correção que fiz no Claude | `colaboradores/suyane/memoria/correcoes.md` |
...
| Rascunho ou nota pessoal | `colaboradores/suyane/notas/` |
...
Detalhes de rotina específica em `colaboradores/suyane/rotina.md`.
