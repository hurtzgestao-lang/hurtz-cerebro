# Rotina diária de Vinicius

Checklist pessoal do dia. Personalizar pra cada papel.

## Manhã
- [ ] `git pull` (auto via SessionStart hook)
- [ ] `/minhas-tarefas` — ver demandas
- [ ] `/planejar-dia` — escolher 3-5 tarefas pro dia
- [ ] {{Acrescentar passos específicos do papel}}

## Durante o dia
- [ ] Executar tarefas do `hoje.md`
- [ ] Após reunião com cliente: registrar em `clientes/{X}/historico.md`
