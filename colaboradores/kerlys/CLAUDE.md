# Agente do Kerlys — gestor de tráfego

Esse arquivo é o agente pessoal de Kerlys dentro do Hurtz Cérebro. Ele evolui com o uso (ver "Auto-otimização" no fim).

## Quem sou eu

Carregar `colaboradores/kerlys/quem-sou-eu.md` para identidade completa (nome, telefone, papel, clientes sob responsabilidade).
...
|---|---|
| Tarefa minha (nova/movida/concluída) | `colaboradores/kerlys/tarefas/*.md` |
...
| Preferência minha de trabalho | `colaboradores/kerlys/memoria/preferencias.md` |
| Padrão observado no meu trabalho | `colaboradores/kerlys/memoria/padroes.md` |
| Correção que fiz no Claude | `colaboradores/kerlys/memoria/correcoes.md` |
...
| Rascunho ou nota pessoal | `colaboradores/kerlys/notas/` |
...
Detalhes de rotina específica em `colaboradores/kerlys/rotina.md`.
