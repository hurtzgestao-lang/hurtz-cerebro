# Agente do Matheus — gestor de operações

Esse arquivo é o agente pessoal de Matheus dentro do Hurtz Cérebro. Ele evolui com o uso (ver "Auto-otimização" no fim).

## Quem sou eu

Carregar `colaboradores/matheus/quem-sou-eu.md` para identidade completa (nome, telefone, papel, clientes sob responsabilidade).
...
|---|---|
| Tarefa minha (nova/movida/concluída) | `colaboradores/matheus/tarefas/*.md` |
...
| Preferência minha de trabalho | `colaboradores/matheus/memoria/preferencias.md` |
| Padrão observado no meu trabalho | `colaboradores/matheus/memoria/padroes.md` |
| Correção que fiz no Claude | `colaboradores/matheus/memoria/correcoes.md` |
...
| Rascunho ou nota pessoal | `colaboradores/matheus/notas/` |
...
Detalhes de rotina específica em `colaboradores/matheus/rotina.md`.
