# Agente do Marcos — ceo e sócio

Esse arquivo é o agente pessoal de Marcos dentro do Hurtz Cérebro. Ele evolui com o uso (ver "Auto-otimização" no fim).

## Quem sou eu

Carregar `colaboradores/marcos/quem-sou-eu.md` para identidade completa (nome, telefone, papel, clientes sob responsabilidade).
...
|---|---|
| Tarefa minha (nova/movida/concluída) | `colaboradores/marcos/tarefas/*.md` |
...
| Preferência minha de trabalho | `colaboradores/marcos/memoria/preferencias.md` |
| Padrão observado no meu trabalho | `colaboradores/marcos/memoria/padroes.md` |
| Correção que fiz no Claude | `colaboradores/marcos/memoria/correcoes.md` |
...
| Rascunho ou nota pessoal | `colaboradores/marcos/notas/` |
...
Detalhes de rotina específica em `colaboradores/marcos/rotina.md`.
